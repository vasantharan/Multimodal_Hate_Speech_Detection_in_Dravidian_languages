...
label_encoder_path = '../label encoder/label_encoder_classes.npy'
text_label_encoder_path = '../label encoder/tamil_label_encoder.pkl'
...
audio_model = tf.keras.models.load_model('../models/tamil_best_audio_model.keras')
text_model = tf.keras.models.load_model('../models/best_tamil_hyper_classification_model.h5')
feature_extractor = "xlm-roberta-large"

test_dir = '../tamil/'
text_result_file = 'the_deathly_hallows_Tamiltext.tsv'
audio_result_file = 'the_deathly_hallows_Tamilaudio.tsv'
...
text_df['File Name'] = dataset_df['File Name'].str.replace('../test/tamil/audio/', '', regex=False)
text_df['Class Label Short'] = text_labels
text_df.to_csv(text_result_file, sep='\t', index=False)
print('Text Classification Done')

audio_df['File Name'] = dataset_df['File Name'].str.replace('../test/tamil/audio/', '', regex=False)
